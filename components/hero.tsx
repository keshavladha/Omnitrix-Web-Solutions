...
export function Hero() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden px-0 pb-20 pt-28">
      ...
      <div className="absolute left-1/2 top-20 h-[36rem] w-[36rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(16,185,129,0.06),transparent_68%)]" />
      ...
      <div className="container relative grid items-center gap-12 lg:grid-cols-[1.08fr_0.92fr]">
        <div>
          <Reveal>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/5 px-4 py-2 text-sm text-emerald-400 font-semibold backdrop-blur">
          ...
          <Reveal delay={0.32}>
            <div className="mt-10 flex flex-wrap gap-3 text-sm text-slate-400 font-medium">
              {["Fast", "SEO Optimized", "Mobile First", "Scalable"].map((item) => (
                <span key={item} className="inline-flex items-center gap-2 rounded-full border border-white/5 bg-slate-950/40 px-4 py-2">
          ...
          <TiltCard className="glass relative mx-auto w-full max-w-[500px] overflow-hidden rounded-2xl p-5 shadow-md">
            ...
            <div className="rounded-xl border border-white/5 bg-slate-950/40 p-5">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.24em] text-emerald-450 font-bold">Growth System</p>
                  <h2 className="mt-2 font-display text-2xl font-semibold text-white">Website Conversion Engine</h2>
                </div>
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-emerald-500 text-black shadow-sm">
              ...
              <div className="mt-8 grid gap-3">
                {[
                  ...
                  <div key={item.value} className="rounded-xl border border-white/5 bg-slate-950/60 p-4 shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                    <div className="flex items-start gap-3">
                      <item.icon className="mt-1 h-5 w-5 text-emerald-450" aria-hidden />
                      <div>
              ...
              <div className="mt-5 rounded-xl border border-white/5 bg-slate-900/40 p-5">
                <div className="flex items-center justify-between text-sm text-slate-400 font-medium">
                  <span>Launch readiness</span>
                  <span className="font-bold text-emerald-400">Premium</span>
                </div>
                <div className="mt-4 h-2 rounded-full bg-slate-950">
                  <div className="h-full w-[92%] rounded-full bg-gradient-to-r from-emerald-450 to-emerald-600" />
                </div>
                <div className="mt-5 grid grid-cols-3 gap-3 text-center">
                  {[
                    ...
                    <div key={label} className="rounded-lg bg-slate-950/60 p-3 border border-white/5 shadow-[0_2px_6px_rgba(0,0,0,0.02)]">
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <div className="rounded-xl border border-white/5 bg-slate-950/40 p-4">
                <BarChart3 className="h-5 w-5 text-emerald-450 animate-pulse" />
                <p className="mt-4 text-sm font-semibold text-white">Analytics-ready</p>
              </div>
              <div className="rounded-xl border border-white/5 bg-slate-950/40 p-4">
                <ShieldCheck className="h-5 w-5 text-emerald-450" />
                <p className="mt-4 text-sm font-semibold text-white">Secure forms</p>
              </div>
            </div>
          </TiltCard>
        </Reveal>
